...
namespace KosovaPOS.Models.BMDData
{
    ...
    public class Artikujt
    {
        ...
        /// </summary>
        [Column("PizzaPriceSmall")]
        public double? PizzaPriceSmall { get; set; }

        /// <summary>
        /// Pizza pricing for medium size (e.g., 30cm)
        /// </summary>
        [Column("PizzaPriceMedium")]
        public double? PizzaPriceMedium { get; set; }

        /// <summary>
        /// Pizza pricing for large size (e.g., 35cm)
        /// </summary>
        [Column("PizzaPriceLarge")]
        public double? PizzaPriceLarge { get; set; }

        /// <summary>
        /// Is this product a pizza? (to enable size-based pricing)
        /// </summary>
        [Column("IsPizza")]
        ...
        [Column("IsActive")]
        public bool? IsActiveProp { get; set; } // Active/Inactive flag

        [Column("StoguMinimal")]
        public double? StoguMinimal { get; set; } // Minimum stock threshold
        ...
        [NotMapped]
        public decimal VATRate => Tatimi != null ? (decimal)Tatimi.Value : (Vat == 3 ? 18m : Vat == 2 ? 8m : 0m);

        [NotMapped]
        public bool IsActive => IsActiveProp ?? true;
    }
}
