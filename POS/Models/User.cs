...
namespace KosovaPOS.Models
{
    ...
    public class User
    {
        ...
        // New module permissions (added for expanded app modules)
        public bool CanManageDelivery { get; set; } = false;
        public bool CanManageKitchen { get; set; } = false;
        public bool CanManageTables { get; set; } = false;
        public bool CanManageLoyalty { get; set; } = false;
        public bool CanViewAnalytics { get; set; } = true;
        public bool CanManageInventory { get; set; } = false;
        public bool CanAccessStaffScheduling { get; set; } = false;
    }
}
